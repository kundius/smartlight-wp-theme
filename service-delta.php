    ...
    <div class="wrapper">
      ...
      <div class="service-delta-intro" style="background-image: url(<?php echo get_field('background')['url'] ?>)">
        ...
        <div class="container">
          ...
          <button class="service-delta-intro__button" data-modal-form="Кнопка в начале страницы" data-modal="#consultation"><span>Заказать консультацию</span></button>
      ...
      <div class="service-objects service-objects_<?php echo $post->post_name ?>" data-slider>
        <div class="container">
