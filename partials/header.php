...
<button class="header__request" data-modal-form="Получить предложение!" data-modal-title="Получить оценку монтажа праздничного освещения с бесплатной визуализацией!" data-modal="#callback">
